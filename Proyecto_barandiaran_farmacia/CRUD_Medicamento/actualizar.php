    ...
    <body>
                <div class="container mt-5">
                    <form action="update.php" method="POST">
                                ...
                                <input type="text" class="form-control mb-3" name="Antibiotico" placeholder="Antibiotico" value="<?php echo $row['Antibiotico']  ?>">
                                ...
                                <input type="date" class="form-control mb-3" name="Fecha_Caducidad" placeholder="Fecha_Caducidad" value="<?php echo $row['Fecha_Caducidad']  ?>">
